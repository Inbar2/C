...
/*pointer to function that executes action on element*/
typedef int	(*ActionFunction)(const void *_elem, void * _context);

/*pointer to function that compare between two void* elements*/
 ...
 */
Vector* Heap_Destroy(Heap** _heap); /*There is no destroying the vector*/
 ...
 */
size_t Heap_ForEach(const Heap* _heap, ActionFunction _act, void* _context); /*foreach musn't change key value*/
